import { currentWeather } from "../../pages/HomePage/londonCC";
import { fiveDay } from "../../pages/HomePage/london5day";
...
export function getCurrentCityData(city) {
  return async function (dispatch, _, DataService) {
    try {
      ...
      const responseCurrentConditon = await DataService.getCurrentCondition(city.id)
